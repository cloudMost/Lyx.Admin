...
using Lyx.Admin.Web.Models.Layout;
...
namespace Lyx.Admin.Web.Controllers
{
    public class LayoutController : AdminControllerBase
    {
        ...
        [ChildActionOnly]
        public PartialViewResult CompMenu(string activeMenu = "")
        {
            var model = new SliderMenuViewModel
                        {
                            MainMenu = AsyncHelper.RunSync(() => _userNavigationManager.GetMenuAsync("MainMenu", AbpSession.ToUserIdentifier())),
                            ActiveMenuItemName = activeMenu
                        };

            return PartialView("_CompMenu", model);
        }
